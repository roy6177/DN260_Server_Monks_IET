...
if(! class_exists('WooVina_Extra_Custom_Menu_Widget')) {
	class WooVina_Extra_Custom_Menu_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'woovina_custom_menu',
				esc_html__('&raquo; Custom Menu', 'woovina-extra'),
				array(
					'classname'   => 'widget-woovina-custom-menu custom-menu-widget',
					'description' => esc_html__('Displays custom menu.', 'woovina-extra'),
		...
		public function widget($args, $instance) {
			...
			echo $args['before_widget'];
				...
				$nav_menu_args = array(
					...
					'walker'        => new WooVina_Extra_Nav_Walker(),
				);

				// Add classes
				$classes 	= array('woovina-custom-menu', 'clr');
		...
		public function form($instance) {
			...
			<p class="nav-menu-widget-no-menus-message" <?php if(! empty($menus)) { echo ' style="display:none" '; } ?>>
				...
				?>
				<?php echo sprintf(esc_html__('No menus have been created yet. <a href="%s">Create some</a>.', 'woovina-extra'), esc_attr($url)); ?>
			</p>
			<div class="nav-menu-widget-form-controls" <?php if(empty($menus)) { echo ' style="display:none" '; } ?>>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>"><?php esc_html_e('Select Menu:', 'woovina-extra'); ?></label>
					<select class="widget-select widefat" id="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>" name="<?php echo esc_attr($this->get_field_name('nav_menu')); ?>">
						<option value="0"><?php esc_html_e('&mdash; Select &mdash;', 'woovina-extra'); ?></option>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('nav_padding')); ?>"><?php esc_html_e('Menu Padding:', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('nav_link_color')); ?>"><?php esc_html_e('Menu Link Color:', 'woovina-extra'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('nav_link_hover_color')); ?>"><?php esc_html_e('Menu Link Hover Color:', 'woovina-extra'); ?></label>
...
register_widget('WooVina_Extra_Custom_Menu_Widget');