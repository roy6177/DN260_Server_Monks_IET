			...
			<div id="FBC_chat" class="chat-widget">
					...
					<div id="FBC_offline" class="chat-body chat-form" style="<?php echo $args['form_width'] ?>">
							...
							<form id="FBC_popup_form" action="">
								...
								<div class="form-line">
										<input type="text" name="name" id="FBC_msg_name" placeholder="<?php _e( 'Please enter your name', 'wc-frontend-manager-ultimate' ) ?>">
								...
								<div class="form-line">
										<input type="email" name="email" id="FBC_msg_email" placeholder="<?php _e( 'Please enter your email', 'wc-frontend-manager-ultimate' ) ?>">
