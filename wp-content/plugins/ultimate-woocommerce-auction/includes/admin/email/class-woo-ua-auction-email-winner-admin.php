 ...
 *
 *
 * @class WOO_UA_Email_Auction_Winner_Admin
 * @author Nitesh Singh 
 * @since 1.0  
 *
 */

if ( ! class_exists( 'WOO_UA_Email_Auction_Winner_Admin' ) ) {
    /**
     * Class WOO_UA_Email_Auction_Winner_Admin
     *
     * @author Nitesh Singh 
     */
    class WOO_UA_Email_Auction_Winner_Admin extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = __('​Auction Won - Admin', 'woo_ua');			
            $this->description = __('​Can be sent to admin when the auction ends and has a winner', 'woo_ua');
            $this->heading = __('Auction Product Won by User on {site_title}', 'woo_ua');
            $this->subject = __('Auction Product Won by User on {site_title}', 'woo_ua');          
            ...
            add_action( 'woo_ua_auctions_won_email_admin', array( $this, 'trigger' ), 10, 2 );
...
return new WOO_UA_Email_Auction_Winner_Admin();
