...
function wcfm_orders_details_easypost_shipping() { 
	...
	$order_status = sanitize_title( $theorder->get_status() );
	if( !in_array( $order_status, apply_filters( 'wcfm_easypost_allowed_order_status', array( 'pending', 'on-hold', 'processing', 'completed' ) ) ) ) return;
